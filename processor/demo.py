...
import torch
import skvideo
skvideo.setFFmpegPath('D:/ljm/ffmpeg-4.2.1-win64-static/ffmpeg-4.2.1-win64-static/bin/')
import skvideo.io
...
class Demo(IO):
    ...
    """
    def start(self):
        openpose = '{}/bin/OpenPoseDemo.exe'.format(self.arg.openpose)
        ...
        data = data.unsqueeze(0)#在第一维增加一个维度
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--video',
            default='D:/ljm/1/st-gcn-master/resource/media/00393.avi',
            help='Path to video')
        parser.add_argument('--openpose',
            default='D:/ljm/openpose-1.4.0/windows',
